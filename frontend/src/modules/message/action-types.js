const modulePrefix = 'Message/';

// export const EDIT_MESSAGE = `${modulePrefix}EDIT_MESSAGE`;
// export const EDIT_MESSAGE_SUCCESS = `${modulePrefix}EDIT_MESSAGE_SUCCESS`;
// export const EDIT_MESSAGE_FAILED = `${modulePrefix}EDIT_MESSAGE_FAILED`;

// export const DELETE_MESSAGE = `${modulePrefix}DELETE_MESSAGE`;
